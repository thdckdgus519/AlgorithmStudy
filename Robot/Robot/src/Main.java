...
public class Main 
{
	public static void main(String args[])
	{
			...
			for(int j = 0 ; j < iarray[i].loop ; j++)
			{
				if(iarray[i].status.equals("F"))
				{
					if(array[iarray[i].number].getStatus().equals("N"))
					{
						...
						{
							flag = 2;
							robot_1 = iarray[i].number;
							for(int k = 0 ; k < N ; k++)
							{
								if(array[iarray[i].number].getY() - 1 == array[k].getY() && array[iarray[i].number].getX() == array[k].getX())
									robot_2 = k;
							}
							flag2 = 1;
							break;
					...
					else if(array[iarray[i].number].getStatus().equals("E"))
					{
						...
						else if(map[array[iarray[i].number].getY()][array[iarray[i].number].getX() + 1] == 1)
						{
							...
							for(int k = 0 ; k < N ; k++)
							{
								if(array[iarray[i].number].getY() == array[k].getY() && array[iarray[i].number].getX()+1 == array[k].getX())
									robot_2 = k;
							}
							flag2 = 1;
							break;
		...
		if(flag == 0)
			...
			System.out.println("Robot " + (robot_1+1) + " crashes into robot " + (robot_2+1));
	}
